...
struct FONIXFLOWTRACKERSETUP_API FTrackingConnectionSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FONIXFLOWTRACKERSETUP_API FCameraSetupConfig
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FONIXFLOWTRACKERSETUP_API FFonixFlowTrackerResult
{
	GENERATED_BODY()
