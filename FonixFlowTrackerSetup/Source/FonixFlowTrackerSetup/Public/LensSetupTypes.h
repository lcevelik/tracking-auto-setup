...
struct FONIXFLOWTRACKERSETUP_API FLensEncoderRange
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FONIXFLOWTRACKERSETUP_API FLensConfiguration
{
	GENERATED_BODY()
...
class FONIXFLOWTRACKERSETUP_API ULensSetupUtility : public UObject
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "FonixFlow Tracker Setup")
