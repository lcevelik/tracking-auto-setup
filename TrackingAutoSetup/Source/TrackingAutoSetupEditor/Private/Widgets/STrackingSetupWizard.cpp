...
TSharedRef<SWidget> STrackingSetupWizard::BuildLensSelectionStep()
{
	return SNew(SVerticalBox)
...
TSharedRef<SWidget> STrackingSetupWizard::BuildSensorSettingsStep()
{
	return SNew(SVerticalBox)
...
void STrackingSetupWizard::RefreshLensFileList()
{
