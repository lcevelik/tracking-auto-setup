 ...
 */
UCLASS()
class TRACKINGAUTOSETUP_API UTrackingAutoSetupSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tracking Auto Setup", meta = (WorldContext = "WorldContextObject"))
	static FTrackingSetupResult SetupFreeDCamera(
		UObject* WorldContextObject,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tracking Auto Setup", meta = (WorldContext = "WorldContextObject"))
	static FTrackingSetupResult SetupOpenTrackCamera(
		UObject* WorldContextObject,
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Tracking Auto Setup", meta = (WorldContext = "WorldContextObject"))
	static bool RemoveTrackingSetup(
		UObject* WorldContextObject,
